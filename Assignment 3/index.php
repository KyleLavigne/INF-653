...
switch ($action) {
    ...
    case "update_assignment":
        ...
        if ($assignment_id == NULL || $assignment_id == FALSE || $description == NULL || $description == FALSE || $course_id == NULL || $course_id == FALSE) {
            $error = "Invalid assignment data. Check all fields and try again.";
            include('view/error.php');
        } else {
    ...
    case "update_course":
        ...
        if ($course_id !== null && $course_id !== false && $course_name) {
